        ...
        <section class="form-section" id="completar-registro">
            ...
            <form action="../../controllers/control_completarEntrenador.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <select name="codEscuela" id="codEscuela" required autocomplete="off">
            ...
            <form action="../../controllers/control_registrarEquipo.php" method="POST" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nombreEquipo" name="nombreEquipo" required maxlength="30" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="categoria">Categoría *</label>
                        <select id="categoria" name="idCategoria" required autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <select id="evento" name="evento" required autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <select id="escuelaEquipo" name="codEscuela" required autocomplete="off">
            ...
            <form action="../../controllers/control_registrarParticipante.php" method="POST" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="numControl" id="numControl" required autocomplete="off" step="1">
                    </div>

                    <div class="form-group">
                        <label for="nombre">Nombre *</label>
                        <input type="text" name="nombre" id="nombre" required pattern="[A-Za-zÁÉÍÓÚáéíóúñÑ ]+" maxlength="30" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="apellidoPat">Apellido Paterno *</label>
                        <input type="text" name="apellidoPat" id="apellidoPat" required pattern="[A-Za-zÁÉÍÓÚáéíóúñÑ ]+" maxlength="30" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="apellidoMat">Apellido Materno *</label>
                        <input type="text" name="apellidoMat" id="apellidoMat" required pattern="[A-Za-zÁÉÍÓÚáéíóúñÑ ]+" maxlength="30" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="edad">Edad *</label>
                        <input type="number" name="edad" id="edad" required autocomplete="off" step="1">
                    </div>

                    <div class="form-group">
                        <label for="sexo">Sexo *</label>
                        <select name="sexo" id="sexo" required autocomplete="off">
