    ...
    <div class="split-screen">
        ...
        <div class="right-pane">
            <div class="form-container">
                ...
                <form action="../../controllers/control_registro.php" method="POST" class="register-form" autocomplete="off">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="password" name="password" placeholder="Crea una contraseña segura" required minlength="8" maxlength="30" autocomplete="new-password">
                        </div>
